...
__export(privacy_exports, {
  allowPopupsFrom: () => allowPopupsFrom,
  blockPopups: () => blockPopups,
  disableStealthMode: () => disableStealthMode,
  enableStealthMode: () => enableStealthMode,
  isBlockingPopups: () => isBlockingPopups,
  isDoNotSellSignalActive: () => isDoNotSellSignalActive,
  isStealthModeActive: () => isStealthModeActive,
  metrics: () => metrics,
  removeMetaRefresh: () => removeMetaRefresh,
  restorePopups: () => restorePopups,
  sendDoNotSellSignal: () => sendDoNotSellSignal
});
